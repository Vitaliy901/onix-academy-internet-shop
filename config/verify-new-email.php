...
return [
     ...
     */
    'route' => 'myPendingEmail.verifyNewEmail',

    /**
     * Here you can specify the name of a custom URL prefix for the API client to handle the verification.
     */
    'api_url' => 'http://spa.test?email_verify_url=',
